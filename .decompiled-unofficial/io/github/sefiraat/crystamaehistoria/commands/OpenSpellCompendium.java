...
public class OpenSpellCompendium
extends SubCommand {
    ...
    protected void execute(CommandSender sender, String[] args) {
        if (sender instanceof Player) {
            ...
            playerProfile.ifPresent(profile -> ItemGroups.SPELL_COLLECTION.open(player, (PlayerProfile)profile, SlimefunGuideMode.SURVIVAL_MODE));
        }
    }
