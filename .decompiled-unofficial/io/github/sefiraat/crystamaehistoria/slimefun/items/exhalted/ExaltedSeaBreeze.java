...
public class ExaltedSeaBreeze
extends ExaltedItem {
    private static final Map<Material, Material> MATERIAL_MAP = new EnumMap<Material, Material>(Material.class);
    ...
    public void onExalt(ExaltedItem slimefunItem, Location location) {
        for (int i = 0; i < 4; ++i) {
            ...
            Block block = location.add((double)x, -1.5, (double)(z = ThreadLocalRandom.current().nextInt(-5, 6))).getBlock();
