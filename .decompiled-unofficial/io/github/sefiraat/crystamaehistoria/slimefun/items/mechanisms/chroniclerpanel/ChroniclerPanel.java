...
extends TickingMenuBlock {
    ...
    protected static final Map<Location, ChroniclerPanelCache> CACHES = new HashMap<Location, ChroniclerPanelCache>();
    ...
    private BlockPlaceHandler onBlockPlace() {
        return new BlockPlaceHandler(false){
            ...
            public void onPlayerPlace(@Nonnull BlockPlaceEvent event) {
                ...
                ChroniclerPanelCache cache = new ChroniclerPanelCache(BlockStorage.getInventory((Location)location), ChroniclerPanel.this.tier);
