...
extends Spell {
    public FrostNova() {
        SpellCoreBuilder spellCoreBuilder = new SpellCoreBuilder(20.0, true, 10.0, false, 10, false).makeDamagingSpell(2.0, true, 1.0, false).makeProjectileSpell(this::fireProjectiles, 2.0, false, 1.0, false).makeProjectileVsEntitySpell(this::projectileHit);
    ...
    public void projectileHit(CastInformation castInformation) {
        for (LivingEntity livingEntity : this.getTargets(castInformation, this.getProjectileAoe(castInformation), true)) {
            ...
            ParticleUtils.displayParticleEffect((Entity)livingEntity, Particle.SNOWFLAKE, 1.0, 5);
        }
    }
    ...
    public RecipeSpell getRecipe() {
        return new RecipeSpell(1, StoryType.ELEMENTAL, StoryType.MECHANICAL, StoryType.VOID);
    }

    @Override
    @Nonnull
    public String[] getLore() {
        return new String[]{"Summons a massive nova of snowballs", "around you to freeze foes."};
    }
