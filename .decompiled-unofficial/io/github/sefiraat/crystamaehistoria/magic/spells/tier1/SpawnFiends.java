...
extends Spell {
    ...
    public void cast(CastInformation castInformation) {
        ...
        for (int i = 0; i < castInformation.getStaveLevel(); ++i) {
            ...
            Phantom phantom = (Phantom)SpellUtils.summonTemporaryMob(EntityType.PHANTOM, caster, spawnLocation, new FiendGoal(caster), 180).getMob();
            phantom.setSize(2);
    ...
    public RecipeSpell getRecipe() {
        return new RecipeSpell(1, StoryType.ANIMAL, StoryType.VOID, StoryType.PHILOSOPHICAL);
    }

    @Override
    @Nonnull
    public String[] getLore() {
        return new String[]{"Summons 1-5 fiends to attack your enemies.", "Fiends are erratic and do not follow the caster."};
    }
