...
extends Spell {
    public Teleport() {
        SpellCoreBuilder spellCoreBuilder = new SpellCoreBuilder(20.0, true, 20.0, false, 5, true).makeInstantSpell(this::cast);
    ...
    public RecipeSpell getRecipe() {
        return new RecipeSpell(1, StoryType.ELEMENTAL, StoryType.HISTORICAL, StoryType.VOID);
    }

    @Override
    @Nonnull
    public String[] getLore() {
        return new String[]{"Teleports the caster x blocks forward."};
    }
