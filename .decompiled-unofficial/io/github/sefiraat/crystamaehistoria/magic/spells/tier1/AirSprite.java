...
extends Spell {
    ...
    public void cast(CastInformation castInformation) {
        ...
        for (int i = 0; i < castInformation.getStaveLevel(); ++i) {
            ...
            SpellUtils.summonTemporaryMob(EntityType.VEX, caster, spawnLocation, new BoringGoal(caster), this::onTick);
        }
    }

    @ParametersAreNonnullByDefault
    public void onTick(MagicSummon magicSummon) {
        ParticleUtils.displayParticleEffect((Entity)magicSummon.getMob(), Particle.CLOUD, 1.0, 2);
    }

    @Override
    @Nonnull
    public RecipeSpell getRecipe() {
        return new RecipeSpell(1, StoryType.ELEMENTAL, StoryType.ANIMAL, StoryType.CELESTIAL);
    }

    @Override
    @Nonnull
    public String[] getLore() {
        return new String[]{"Summons 1-5 air sprites to attack", "your enemies."};
    }
