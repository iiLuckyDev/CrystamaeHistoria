...
public enum SpellType {
    ...
    private static final SpellType[] cachedValues;
    ...
    public static Spell getById(String id) {
        for (SpellType spellType : SpellType.getCachedValues()) {
            if (!spellType.getId().equals(id)) continue;
    ...
    public static void setupEnabledSpells() {
        enabledSpells = (SpellType[])Arrays.stream(SpellType.values()).filter(spellType -> spellType.getSpell().isEnabled()).toArray(SpellType[]::new);
    }
    ...
    @Generated
    public static SpellType[] getCachedValues() {
        return cachedValues;
    }

    @Generated
    public static SpellType[] getEnabledSpells() {
