...
public class StoryChances {
    ...
    public StoryChances(int basic, int uncommon, int rare, int epic, int mythical) {
        ...
        Preconditions.checkArgument((boolean)validTotal, (Object)"Chances must add up to 100 for a StoryChance");
        this.basic = basic;
    ...
    public int getBasic() {
        return this.basic + this.getUncommon();
    }

    public int getUncommon() {
        return this.uncommon + this.getRare();
    }

    public int getRare() {
        return this.rare + this.getEpic();
    }

    public int getEpic() {
        return this.epic + this.getMythical();
    }
